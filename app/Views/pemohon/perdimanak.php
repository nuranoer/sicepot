				...
				<form class="row" id="checkout-form" action="include/form.php" method="post" enctype="multipart/form-data">
					...
					<div class="col-lg-12">
						<div class="row checkout-form-billing">
							...
							<div class="col-6 form-group">
								<label>No. KTP Ortu:</label><br>
								<input type="text" name="no_ktp_ortu" id="no_ktp_ortu" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-6 form-group">
								<label>Tanggal Dikeluarkannya KTP:</label><br>
								<input type="text" value="" class="form-control required text-start component-datepicker format" placeholder="DD-MM-YYYY">
							</div>
							<div class="col-6 form-group">
								<label>No. Paspor Ortu:</label><br>
								<input type="text" name="no_paspor_ortu" id="no_paspor_ortu" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-6 form-group">
								<label>Tanggal Dikeluarkannya Paspor:</label><br>
								<input type="text" value="" class="form-control required text-start component-datepicker format" placeholder="DD-MM-YYYY">
							</div>
							<div class="col-6 form-group">
