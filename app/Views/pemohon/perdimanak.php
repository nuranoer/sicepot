				...
				<div class="col-lg-12">
					<div class="row checkout-form-billing">
						...
						<div class="col-12 form-group">
							...
							<input type="text" name="nama_anak" id="nama_anak" class="form-control required" value="" placeholder="" autofocus>
						</div>
						<div class="col-12 form-group">
						...
						<div class="col-4 form-group">
							...
							<input type="text" name="tgl_berlaku_kia" id="tgl_berlaku_kia" class="form-control required" value="" placeholder="01-12-2015">
						</div>
						<div class="col-4 form-group">
