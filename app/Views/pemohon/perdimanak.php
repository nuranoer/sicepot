					...
					<div class="col-lg-12">
						<div class="row checkout-form-billing">
							...
							<div class="col-12 form-group">
								...
								<input type="text" name="nama_anak" id="nama_anak" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-12 form-group">
							...
							<div class="col-6 form-group">
								...
								<input type="text" name="ttl_anak" id="ttl_anak" class="form-control required" value="" placeholder="Kediri, 01-01-2010">
							</div>
							...
							<div class="col-4 form-group">
								...
								<input type="text" name="tgl_berlaku_kia" id="tgl_berlaku_kia" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-4 form-group">
								<label>berlaku s/d:</label><br>
								<input type="text" name="rentang_tgl_kia" id="rentang_tgl_kia" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-12 form-group">
								<label>Alamat Anak:</label>
								<input type="text" name="alamat_anak" id="alamat_anak" class="form-control required" value="">
							</div>
							<div class="col-12 form-group">
							...
							<div class="col-6 form-group">
								...
								<input type="text" name="ttl_ibu" id="ttl_ibu" class="form-control required" value="" placeholder="Kediri, 03-03-1986">
							</div>
							<div class="col-12 form-group">
							...
							<div class="col-4 form-group">
								...
								<input type="text" name="no_ktp_ibu" id="no_ktp_ibu" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-4 form-group">
								<label>Tgl Diberikan KTP Ibu:</label><br>
								<input type="text" name="tgl_ktp_ibu" id="no_ktp_ibu" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-4 form-group">
								<label>Berlaku s/d:</label><br>
								<input type="text" name="rentang_ktp_ibu" id="rentang_ktp_ibu" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-12 form-group">
								<label>No. Paspor Ibu:</label><br>
								<input type="text" name="no_paspor_ibu" id="no_paspor_ibu" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-6 form-group">
							...
							<div class="col-6 form-group">
								...
								<input type="text" name="ttl_ayah" id="ttl_ayah" class="form-control required" value="" placeholder="Kediri, 02-02-1985">
							</div>
							<div class="col-12 form-group">
							...
							<div class="col-4 form-group">
								...
								<input type="text" name="no_ktp_ayah" id="no_ktp_ayah" class="form-control required" value="" placeholder="">
							</div>
							<div class="col-4 form-group">
							...
							<div class="col-4 hidden form-group">
								<label>Negara Tujuan:</label><br>
								<input type="text" name="negara" id="negara" class="form-control" value="" placeholder="">
							</div>
