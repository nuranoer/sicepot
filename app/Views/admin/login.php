						...
						<div class="container-fluid py-5 mx-auto">
							...
							<div class="card mx-auto rounded-0 border-0" style="max-width: 400px; background-color: rgba(255,255,255,0.93);">
								<div class="card-body" style="padding: 40px;">
                                    ...
                                    <div class="center">
								<a href="/loginadmin"><img src="HTML/images/login/logo.png" alt="Imigrasi Logo" width="150"></a>
							...
							<div class="text-center dark mt-3"><small>Copyrights &copy; Kantor Imigrasi Kelas II Non TPI Kediri</small></div>
						</div>
					</div>
				</div>
