	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			<div class="content-wrap py-0">
				...
				<div class="section p-0 m-0 h-100 position-absolute" style="background: url('HTML/images/parallax/home/1.jpg') center center no-repeat; background-size: cover;"></div>

				<div class="section bg-transparent min-vh-100 p-0 m-0">
					<div class="vertical-middle">
						<div class="container-fluid py-5 mx-auto">
							<div class="center">
								<a href="/loginadmin"><img src="HTML/images/logo-dark.png" alt="Canvas Logo"></a>
							</div>
