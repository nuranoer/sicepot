			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="/dashboardadmin" class="standard-logo" data-dark-logo="HTML/images/logoimigrasi.png"><img src="HTML/images/logoimigrasi.png" alt="Imigrasi"></a>
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								<li class="menu-item">
									<a class="menu-link" href="/dashboardadmin">
										<div>Home</div>
									</a>
